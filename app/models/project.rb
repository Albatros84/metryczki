...
class Project < ActiveRecord::Base
  ...
  attr_accessible :responsibilities_division_author, :client_author, :highrise_author, :name_author, :project_type_author, :skydrive_author, :basecamp_author,
  ...
  :target_agreed_with_customer_author, :other_expectations_author, :subject_author, :profile_of_participants_author,
  ...
  :merytoryka_author, :conduct_and_summary_of_game_author, :notes_on_materials_author, :notes_on_organization_author, :game_ids_author, :numer_ks_author, :user_roles_id_author
